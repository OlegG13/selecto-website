        ...
        createAnimation: function(element, args) {
            ...
            .on('start', function () {
                ...
                if (element.getAttribute("data-animation") === 'msfitCount') {
                    ...
                    setTimeout(peopleMsfitCount.start.bind(peopleMsfitCount), 400);
                    //setTimeout(publicationsMsfitCount.start.bind(publicationsMsfitCount), 100);
                }
        ...
        createAnimations: function(element) {
            var tween = null,
                ...
                scenes = {
                    ...
                    ourSolutionHead: '{"tween": { "duration": 0.5, "options": { "opacity": 1, "y": 0 } }, "scene": { "options": { "triggerElement": ".page__section--count", "offset": -500, "reverse": false } } }',
